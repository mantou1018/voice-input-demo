export const COMMON_SINGLE_SURNAMES = [
  ...
  '耿', '满', '弘', '匡', '国', '文', '寇', '广', '禄', '阙', '东', '殴',
  '沃', '利', '蔚', '越', '夔', '隆', '师', '巩', '厍', '聂', '晁', '勾',
  '敖', '融', '冷', '訾', '辛', '阚', '那', '简', '饶', '空', '曾', '毋',
  '沙', '养', '鞠', '须', '丰', '巢', '关', '蒯', '相', '查', '后', '荆',
  '红', '游', '竺', '权', '逯', '盖', '益', '桓', '公', '仉', '督', '岳',
  '帅', '缑', '亢', '况', '郈', '有', '琴', '归', '海', '晋', '楚', '闫',
  '法', '汝', '鄢', '涂', '钦', '岳', '帅', '哈', '铁', '依', '完', '颜',
] as const;
...
export const COMMON_COMPOUND_SURNAMES = [
  ...
  '呼延', '东郭', '南门', '羊舌', '微生', '公户', '公玉', '公仪', '梁丘', '左丘',
  '东门', '西门', '南荣', '第五', '公坚', '公伯', '公祖', '公乘', '贯丘', '公皙',
] as const;
